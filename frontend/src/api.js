...
export const addTaskManually      = (name)   => axios.post(`${BASE}/tasks/manual`, { name }).then(r => r.data);
export const removeCompletedTask  = (id)     => axios.delete(`${BASE}/tasks/complete/${id}`).then(r => r.data);
...
export const updateOtherProjects  = (projects) => axios.put(`${BASE}/other-projects`, { projects }).then(r => r.data);
